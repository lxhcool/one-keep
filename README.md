...
| 项目 | 信息 |
|---|---|
| **服务器** | `119.45.243.103` (root, SSH 密钥登录) |
...
# 查看 PM2 进程
ssh root@119.45.243.103 "pm2 list"

# 查看服务日志
ssh root@119.45.243.103 "pm2 logs one-keep-server --lines 50"

# 查看端口监听
ssh root@119.45.243.103 "lsof -i :3002"

# 服务器本机健康检查
ssh root@119.45.243.103 "curl http://127.0.0.1:3002/api/health"
```
