  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark
              ? const Color(0x20308781)
              : const Color(0x30D4E5E3),
          width: 1,
        ),
        boxShadow: [
          BoxShadow(
          ...
          BoxShadow(
            color: isDark
                ? const Color(0x10308781)
                : const Color(0x08D4E5E3),
            blurRadius: 8,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: tone.withValues(alpha: isDark ? 0.15 : 0.1),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    isDark ? const Color(0x50308781) : const Color(0x5540E0D0),
                    Colors.transparent,
                  ],
                  stops: const [0.0, 0.7],
                ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    isDark ? const Color(0x35287f79) : const Color(0x40308781),
                    Colors.transparent,
                  ],
                  stops: const [0.0, 0.8],
                ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    isDark ? const Color(0x201e5f5a) : const Color(0x2540E0D0),
                    Colors.transparent,
                  ],
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      isDark ? const Color(0x151e5f5a) : const Color(0x2060F0E0),
                      Colors.transparent,
                    ],
                  ),
                ),
