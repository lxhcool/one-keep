...
class TermsOfServicePage extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _gap(),
            _h2('1. 服务条款的接受'),
            _p('当您勾选并完成注册或登录，即视为您已阅读并同意受本协议及《隐私政策》约束。'),
            _gap(),
            _h2('2. 账户与登录'),
            _p(
              '本服务支持邮箱加密码、用户名加密码等登录方式。您应保证注册信息真实、有效，并自行保管账号、密码和邮箱访问权限。因账号信息失管导致的风险由您自行承担。',
            ),
            _gap(),
            _h2('3. 用户行为规范'),
            ...
            _gap(),
            _h2('4. 服务内容'),
            _p('厘清提供记账录入、账单浏览、统计分析、分类管理等功能。具体功能以当前发布版本实际提供能力为准。'),
            _gap(),
            _h2('5. 数据与责任'),
            _p('您对自行录入、编辑和管理的数据内容负责。对于因您向第三方提供相关信息所产生的后果，由您自行承担。'),
            _gap(),
            _h2('6. 服务可用性'),
  ...
  Widget _p(String t) =>
      Text(t, style: const TextStyle(fontSize: 14, height: 1.6));
